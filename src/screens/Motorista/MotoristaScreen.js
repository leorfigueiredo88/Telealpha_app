        ...
        <View style={styles.modalChecklistContainer}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.formViagem}>
              ...
              <TextInput style={styles.inputViagem} value={kmInicial} editable={false} />
              <Text style={styles.labelInput}>Local de Saída</Text>
              <TextInput style={styles.inputViagem} value={destino} onChangeText={setDestino} placeholder="Ex: Matriz, Av. Paulista, Depósito..." />
            </View>
